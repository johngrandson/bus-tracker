...
-- AddForeignKey
ALTER TABLE "Reservation" ADD CONSTRAINT "Reservation_orderItemId_fkey" FOREIGN KEY ("orderItemId") REFERENCES "OrderItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
